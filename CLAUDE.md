...
- All documentation lives under [`Docs/`](Docs/) — start at [`Docs/README.md`](Docs/README.md).
  ...
  - `Docs/plans/` — implementation plans in planned order. **Latest implemented:** `33-2026-06-15-planning-engine-phase4-experience.md` (Phase 4) + `34-2026-06-16-phase4-pre-merge-followups.md` (F1–F3 + F3-revise/F3-campus), merged to `main` from `feat/phase4-experience`.
