...
export function buildSystemPrompt(opts: SystemPromptOptions = {}): string {
    ...
    lines.push(
        ...
        "   You MUST call `search_policy` next, with the program label + a",
        "   specific phrase (e.g. \"<major name> required courses\",",
        "   \"<major name> elective list\", \"Texts and Ideas course range\")",
        "   to fetch the bulletin's curriculum text, then quote the relevant",
        "   sentence back to the student with its source citation. NEVER guess",
        "   specific course codes from training data. \"CORE-UA 400\" is the START",
        "   of a range, not a single course — \"CORE-UA 400-499\" means \"any one",
        "   Texts and Ideas course\" (CORE-UA 5XX = Cultures and Contexts;",
        "   CORE-UA 7XX = Expressive Culture; the bulletin College Core",
        "   Curriculum page disambiguates).",
        "",
        "TOOL ROUTING:",
