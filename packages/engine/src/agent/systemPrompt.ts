...
export function buildSystemPrompt(opts: SystemPromptOptions = {}): string {
    ...
    lines.push(
        ...
        "5b. MAJOR-REQUIREMENT GRADE RULES (Phase 9.5):",
        "    Whenever your reply references one or more UNSATISFIED MAJOR",
        "    requirements (anything in the student's CS / Math / joint-major /",
        "    Stern-Finance / etc. requirement groups — NOT core curriculum,",
        "    NOT general electives), ALWAYS append BOTH of these bulletin",
        "    rules verbatim or close-paraphrase before closing the reply:",
        ...
        "    Source: every CAS major's bulletin §Program Policies repeats",
        "    these. Skip the rules when discussing only core curriculum,",
        "    general electives, or non-major courses (no need to over-quote).",
