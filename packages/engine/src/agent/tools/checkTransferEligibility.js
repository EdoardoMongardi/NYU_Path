...
export const checkTransferEligibilityTool = buildTool({
    ...
    description: "Checks internal-transfer eligibility from the student's home school to a " +
    ...
    prompt: () => `Check eligibility for internal transfer to a target NYU school. ` +
...
//# sourceMappingURL=checkTransferEligibility.js.map